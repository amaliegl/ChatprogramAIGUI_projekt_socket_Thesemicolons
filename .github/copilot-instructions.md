...
- opbyg løsningen efter objektorienterede principper, så den er let at udvide og vedligeholde.
- lav noter i koden, så andre udviklere kan forstå, hvad der sker.
- brug altid den aktuelle kodebase som udgangspunkt for ændringer.
